...
function Board(containerId, rowsCount, colsCount) {
    ...
    this.render = function () {
        ...
        html += "</table><div class='w3-border-black'><div class='preview'></div></div><div class='score'><p>Game Over</p><p>Your score is <span class='score-value'></span><br>Try Again!!</p></div><button type='button'>Let's Start</button></div>";
